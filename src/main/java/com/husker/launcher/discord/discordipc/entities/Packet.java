 ...
 */
package com.husker.launcher.discord.discordipc.entities;

import java.nio.ByteBuffer;
import org.json.JSONObject;

/**
 * A data-packet received from Discord via an {@link com.husker.launcher.discord.discordipc.IPCClient IPCClient}.<br>
 * These can be handled via an implementation of {@link com.husker.launcher.discord.discordipc.IPCListener IPCListener}.
 *
...
public class Packet
{
     ...
     * and the {@link com.husker.launcher.discord.discordipc.IPCClient IPCClient}
     * connected.
     */
    public enum OpCode
    {
